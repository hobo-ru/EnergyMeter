#ifndef DEFINES_VER_300_H
#define DEFINES_VER_300_H
...
#define FLASH_POW1      ((gpio_t){gpioPortA, 0	})
...
#define SWIO            ((gpio_t){gpioPortF, 1	})	// SWIO

#define S_OPTO_COVER_SUP ((gpio_t){gpioPortA, 8	})  // S3_S4_SUP
#define S_HALL_SUP      S_OPTO_COVER_SUP
#define S_OPTO_BODY_SUP ((gpio_t){gpioPortA, 1	})  // S5_SUP
#define S_OPTO_COVER    ((gpio_t){gpioPortE, 13	})  // S3_S5 //ADC0_1
#define S_HALL          ((gpio_t){gpioPortA, 9	})  // S4
#define S_OPTO_BODY     S_OPTO_COVER
...
#define gpio_INI_FLASH_POW      GPIO_PinModeSet(FLASH_POW1.port, FLASH_POW1.pin, gpioModePushPull, 1)
#define gpio_OFF_FLASH_POW      GPIO_PinModeSet(FLASH_POW1.port, FLASH_POW1.pin, gpioModeDisabled, 0) 
...
#define gpio_GET_S_HALL             GPIO_PinInGet(S_HALL.port, S_HALL.pin)
