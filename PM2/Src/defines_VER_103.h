#ifndef DEFINES_VER_103_H
#define DEFINES_VER_103_H
...
#define FLASH_POW1      ((gpio_t){gpioPortA, 8	})
#define FLASH_POW2      ((gpio_t){gpioPortA, 9	})
...
#define gpio_INI_FLASH_POW      GPIO_PinModeSet(FLASH_POW2.port, FLASH_POW2.pin, gpioModeDisabled, 0); GPIO_PinModeSet(FLASH_POW1.port, FLASH_POW1.pin, gpioModePushPull, 1)
#define gpio_OFF_FLASH_POW      GPIO_PinModeSet(FLASH_POW2.port, FLASH_POW2.pin, gpioModeDisabled, 0); GPIO_PinModeSet(FLASH_POW1.port, FLASH_POW1.pin, gpioModeDisabled, 0) 
...
#define gpio_INI_RSopto_TX      
#define gpio_OFF_RSopto_TX      

#define gpio_INI_RSopto_RX      
#define gpio_OFF_RSopto_RX      
