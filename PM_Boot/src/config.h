...
/* The maximum flash size of any part */
...
#define BOOTLOADER_USART_LOCATION  LEUART_ROUTE_LOCATION_LOC1
 ...
 ******************************************************************************/
#if defined(_EFM32_ZERO_FAMILY) || defined(EFM32TG108F4) \
    || defined(_EFM32_HAPPY_FAMILY) || defined(_EFM32_JADE_FAMILY)
    // NOTE: bootloader for Pearl/Jade/EFR is build using a Jade part.
...
__STATIC_INLINE void CONFIG_UsartGpioSetup(void)
{
  ...
  // LEUART0, location 1:
  // TX: B13, RX: B14
    GPIO->P[1].MODEH = GPIO_P_MODEH_MODE13_PUSHPULL | GPIO_P_MODEH_MODE14_INPUT;
